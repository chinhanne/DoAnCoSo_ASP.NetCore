...
namespace _21b4_dacs.Migrations
{
    /// <inheritdoc />
    public partial class db : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TheLoaiLv2", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TheLoaiLv2_theLoai_TheLoaiId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateCreated = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DateUpdated = table.Column<DateTime>(type: "datetime2", nullable: false),
                    TheLoaiLv2Id = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SanPham", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SanPham_TheLoaiLv2_TheLoaiLv2Id",
                        column: x => x.TheLoaiLv2Id,
                        principalTable: "TheLoaiLv2",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SanPham_TheLoaiLv2Id",
                table: "SanPham",
                column: "TheLoaiLv2Id");

            migrationBuilder.CreateIndex(
                name: "IX_TheLoaiLv2_TheLoaiId",
                table: "TheLoaiLv2",
                column: "TheLoaiId");
        }
